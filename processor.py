...
class Processor(object):
	...
	def __init__(self,ram=None,flash=None,tb_commands=None,db_commands=None,sg_commands=None,*args):
		...
		if(flash==None):
			...
			self.flash=flash
		if(tb_commands==None):
			self.tb_commands={0x1:"mov",0x2:"add",0x3:"sub",0x4:"mul",0x5:"ldi",0xa:"jgt",0xb:"subi",0xc:"addi",0xd:"jle",0xe:"jeq",0xf:"jne",0x10:"jlt",0x13:"jge",0x14:"mod",0x15:"modi",0x16:"div",0x19:"pmov",0x1a:"movp",0x1d:"pjeq",0x1e:"pjne",0x1f:"pjlt",0x20:"pjle",0x21:"pjgt",0x22:"pjge"}
		else:
			self.tb_commands=tb_commands
		if(db_commands==None):
			self.db_commands={0x6:"inc",0x7:"dec",0x8:"neg",0x12:"call",0x17:"pop",0x18:"push",0x1b:"jmp",0x1c:"pjmp"}
		else:
